...
{
     static const int32_t gauss[0x200] = {
    ...
    out =  int16_t((gauss[0x0FF-i] * int32_t(voices[voice].old3)) >> 15);
    out += int16_t((gauss[0x1FF-i] * int32_t(voices[voice].old2)) >> 15);
    out += int16_t((gauss[0x100+i] * int32_t(voices[voice].old1)) >> 15);
    out += int16_t((gauss[0x000+i] * int32_t(voices[voice].next_sample)) >> 15);
